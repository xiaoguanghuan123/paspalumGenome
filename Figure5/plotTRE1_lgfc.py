...
geneGroup = 'tre1;' #'trehalase' #'trpp6'
...
fig, ax = plt.subplots(figsize=(2.5,2.8), tight_layout = True) 
...
ax.set_xticklabels(plotOrder, rotation=20, ha='right')    
ax.set_ylabel('$\it{TRE1}$ log2 fold change',size=10)    #$\it{text you want to show in italics}$
plt.savefig('TRE1_fc.svg')
plt.savefig("TRE1_fc.png",dpi = 500)
