...
dffunc = pd.read_csv("autophagy_gene.csv", sep=',', header = None, usecols=[0,1])
...
fig, ax = plt.subplots(figsize=(1.5,3.5), tight_layout = True)
...
ax.set_ylabel('Expression level change (+ValA/-ValA)')
