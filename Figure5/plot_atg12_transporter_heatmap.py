...
dfATG12 = pd.read_csv('ATG12-1_2nd_NF.csv', index_col = 0)
dfW22['group'] ='W22'
dfATG12['group'] = 'ATG12'
...
ax.set_xticklabels(['WT','ATG12-1'],rotation = 30, ha = 'right')
...
plt.savefig('{0}_atg12_heatmap.svg'.format(geneGroup))
plt.savefig('{0}_atg12_heatmap.png'.format(geneGroup),dpi=500)
