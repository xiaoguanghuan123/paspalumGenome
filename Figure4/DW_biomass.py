...
#dfbiomass = dfbiomass.loc[dfbiomass.Reps=='Rep1']
met = 'AboveGround'
...
for i, species in enumerate(spList):
    ...
    print(species, 'Full', np.median(F_nt), pF)
    print(species, '-N', pN)
    print(species, '-P', pF)
    ...
    sns.swarmplot(x = "Condition", y = met, hue = 'Treatment', data=dfsp, dodge = True,  s=3, palette = 'Set2',  ax=ax)
