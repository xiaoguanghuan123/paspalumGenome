...
#'''
geneGroup = 'Nitrate reductase' #'ammonium transporter' #'nitrate transporter'
#geneGroup = 'trps'
...
dfgene.loc[dfgene['padj']>0.05, 'log2FoldChange']=0
dfgene.to_csv('{0}_FC.csv'.format(geneGroup))
#'''

#dfgene = pd.read_csv(sys.argv[1])
#geneGroup  = sys.argv[1].split('.')[0]
...
fig, ax = plt.subplots(figsize=(1.6,3), tight_layout = True)
